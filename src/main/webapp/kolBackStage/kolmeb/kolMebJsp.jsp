						...
						<div class="display-tc animate-box" data-animate-effect="fadeIn">
							...
							<div class="row" style="display: inline-block;">
								<div class="col-6 col-md-6">
									...
									<div style="background-color: rgb(104, 181, 202)">
										<img src="<%=request.getContextPath()%>/comBackStage/resourceslee/images/Vendor.png" class="card-img-top V_pic" alt="Vendor">
										<!-- <div class="card-body"> -->
										<p>
											<a href="<%=request.getContextPath()%>/comBackStage/companymeb/companyMebJsp2.jsp" class="V_link">廠商</a>
										</p>
									</div>
								</div>
								...
								<div class="col-6 col-md-6">
									<!-- <div class="card" style="width: 350px;"> -->
									<div style="background-color: rgb(227, 172, 181)">
										<img src="<%=request.getContextPath()%>/comBackStage/resourceslee/images/KOL.png" class="card-img-top K_pic" alt="KOL">
										<!-- <div class="card-body"> -->
										<p>
											<a href="<%=request.getContextPath()%>/kolBackStage/kolmeb/kolMebJsp2.jsp" class="K_link">網紅</a>
										</p>
									</div>
								</div>
							</div>

					...
					<ul id="fh5co-gallery-list">
						<c:forEach var="companyMebVO" items="${list}">
							<div class="card" style="width: 300px; height: 250px;"
								...
								<img
									src="<%=request.getContextPath()%>/ReadKolMemberPhoto?com_idnum=${companyMebVO.com_idnum}"
								...
								<div class="card-body">
									...
									<p>
										<span class="fa-li"></span><b>Meb no.:
											${companyMebVO.com_idnum}</b>
									</p>
									<p>
										<span class="fa-li"></span>Email: ${companyMebVO.com_email}
									</p>
									<p>
										<span class="fa-li"></span>Website:${companyMebVO.com_website}
									</p>
									<p>
										<span class="fa-li"></span>Phone:${companyMebVO.com_phone}
									</p>
									<br>
									<br>
									<br>
									...
									<p><a
										 href="<%=request.getContextPath()%>/kolBackStage/matchform/jobview.jsp"><b>VIEW JOB</b></a></p>

				...
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="display-t">
						<div class="display-tc animate-box" data-animate-effect="fadeIn">
							...
							<h1>忘記密碼</h1>
							<p></p>
							<form METHOD="post" ACTION="<%=request.getContextPath()%>/companymeb/ForgetPassword.do">
								<div class="row mb-3">
									<label for="VK_forgetpassword" class="col-md-2 col-form-label">聯絡信箱: </label>
									<div class="col-md-10">
										<input type="email" name="email" class="form-control" id="VK_forgetpassword">
									</div>
								</div>

								<div class="row">
									<div class="col-md-12">
									<button type="submit" class="btn btn-primary" id="VK_member_confirm">確認</button>

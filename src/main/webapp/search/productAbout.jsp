									...
									<div class="row py-lg-5 px-lg-5">
										<div class="col-4 col-md-5">
											  ...
											  <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
												...
												<img width="300" height="300" alt="" src="<%=request.getContextPath()%>/ReadProductAllPhoto?product_num=${productVO.product_num}">
										...
										<div class="col-8 col-md-7 kol_about">
											...
											<div class="kol_ratelv content-md">
												...
												<!-- <p class="user-info-rating d-flex align-items-center"> -->
													...
													<div class="starcomments"><p class="total-rating-out-five">商品名稱:${productVO.product_name}</p></div>
													<div class="starcomments"><p class="total-rating-out-five">商品期限:${productVO.product_deadline}</p></div>
													<div class="starcomments"><p class="total-rating-out-five">招募人數:${productVO.product_count}</p></div>
													<div class="comments"><p class="total-rating">商品介紹:${productVO.product_introduce}</p></div>
												<!-- </p> -->
											</div>
												<FORM METHOD="post"
	...
	<div class="container kol_info">
		<div class="row kol_info">
			<div class="kol_infoTitle">
				<span class="infoTitle">商品資訊</span>
			</div>
			<div class="info">
				<p class="info">合作計畫：${productVO.product_contract}</p>
				<p class="info">商品連結:${productVO.product_link}</p>

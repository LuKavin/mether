				...
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="display-t">
						<div class="display-tc animate-box" data-animate-effect="fadeIn">
							...
							<p style="font-size:18px;">您尚未登入，請重新登入或返回首頁</p><br>
							<font size="3px"><a href='<%=request.getContextPath()%>/login/companyMebJspLogin.jsp'>返回首頁</a></font><br><br>
							<font size="3px"><a href='<%=request.getContextPath()%>/login/companyMebJspLogin.jsp'>重新登入</a></font>
							</div>
						</div>
					</div>
				</div>

														...
														<div class="form-group">
															...
															<div class="input-group">
																...
																<input type="text" class="form-control"
																	...
																	value="${orderMasterVO.order_content}">
															</div>
														</div>

														<c:if test="${(orderMasterVO.order_pic)!=null}">
															<img
																src="<%=request.getContextPath()%>/orderViewpic?order_num=${orderMasterVO.order_num}"
												...
												<div
													...
													<div class="card-body">
														<div class="row">
															...
															<div class="col-sm-6">
																<a
																	href="<%=request.getContextPath()%>/messageViewpic?mes_num=${messageDetailVO.mes_num}"><img
																	src="<%=request.getContextPath()%>/messageViewpic?mes_num=${messageDetailVO.mes_num}"

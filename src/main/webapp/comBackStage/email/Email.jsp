...
List<EmailDetailVO> list = emailDetailService.findMailBox(companyMebVO.getCom_account());
					...
					<div class="card-header">
						<div class="row m-2">
							<i class="fa fa-envelope-open-o" aria-hidden="true"
								style="font-size: 22px;"> <span style="color:orange">${companyMebVO.com_account}</span> 的收件夾</i>
						</div>
					</div>

...
<body bgcolor='white'>
	...
	<div class="container">
		<div class="row text-align">
			...
			<div class="col-sm-8">
				<div class="container h2" style="text-align: center;">新增商品</div>
			</div>
			<div class="col-sm-2"></div>
		</div>
		<br>
						...
						<table>
							...
							<tr>
								...
								<td><select name="product_state">
										<option value="上架" ${(productVO.product_state=="上架")? 'selected':'' }>上架</option>
										<option value="下架" ${(productVO.product_state=="下架")? 'selected':'' }>下架</option>
								</select></td>
							</tr>

...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-sm-4">
			<FORM METHOD="POST"  enctype="multipart/form-data" ACTION="<%=request.getContextPath()%>/product/product.do">
				<div class="sizeholder">
					<table>
						<tr>
						<td>上傳圖片：</td>
						<td>
						<input type="file" accept="image/*"name="p_file" id="p_file"/>
						</td>
						</tr>
						<tr>
							<td>商品名稱</td>
						...
						<tr>
							<td>商品介紹:</td>
							<td><TEXTAREA name="product_introduce" cols="35" rows="3" style="resize:none"
								 ><%= (productVO==null)? "" : productVO.getProduct_introduce()%></TEXTAREA>
							</td>
						</tr>
						<tr>
							<td>商品連結:</td>
						...
						<tr>
							<td>合約內容:</td>
							<td><TEXTAREA name="product_contract" cols="35" rows="3" style="resize:none"
								 ><%= (productVO==null)? "" : productVO.getProduct_contract()%></TEXTAREA>
							</td>
						</tr>
						<tr>
<%
...
%>
							...
							<td><input type="date" name="product_deadline" size="35	"
								 value="<%= (productVO==null)? mintime : productVO.getProduct_deadline()%>" min="<%=mintime%>"/></td>
						</tr>
						<tr>
							<td>預設上下架：</td>
							<td>
		...
		<div class="col-sm-4">
			<div class="row">
				<div id="preview" style="height: 400px;width: 300px;border: 1px solid rgb(202, 201, 201);color: rgb(190, 190, 190);">
					<span class="text">
	...
	document.addEventListener("DOMContentLoaded", function () {
            ...
            document.querySelector("#p_file").addEventListener("change", function (e) {
                if (this.files.length > 0) {
                    ...
                    document.querySelector("#preview .text").innerText = "預覽圖";
                }
            ...
            function preview_img(file) {
                ...
                reader.addEventListener("load", function () {
                    ...
                    document.querySelector("#preview .text").innerText = "";//先清空
					if(document.querySelector("#preview img")!=null){
						document.querySelector("#preview>img").remove();
					}
					document.querySelector("#preview").insertAdjacentHTML("beforeend", post);

...
@WebServlet("/ReadProductAllPhoto")
public class ReadProductAllPhoto extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			ResultSet rs = stmt.executeQuery("SELECT PRODUCT_PHOTO1 FROM PRODUCT_PHOTO WHERE PRODUCT_NUM = " + product_num);

	...
	public void doPost(HttpServletRequest req, HttpServletResponse res)
		...
		if ("getOne_For_Update".equals(action)) { // 來自listAllEmp.jsp的請求
			...
			try {
				...
				String url = "/jobType/update_jobType.jsp";
				...
				RequestDispatcher failureView = req
						.getRequestDispatcher("/jobType/AlljobType.jsp");
...
//				Integer deptno = new Integer(req.getParameter("deptno").trim());
				...
				if (!errorMsgs.isEmpty()) {
					...
					RequestDispatcher failureView = req
							.getRequestDispatcher("/jobType/update_jobType.jsp");
					failureView.forward(req, res);
					return; //程式中斷
				}
...
//				req.setAttribute("jobTypeVO", jobTypeVO); // 資料庫update成功後,正確的的empVO物件,存入req
				String url = "/jobType/AlljobType.jsp";

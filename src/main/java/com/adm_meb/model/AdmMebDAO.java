...
public class AdmMebDAO implements AdmMebDAO_interface {
	...
	private static final String INSERT_STMT = "INSERT INTO ADM_MEB (ADM_ACCOUNT,ADM_PASSWORD,ADM_NAME) VALUES (?, ?, ?)";
	private static final String GET_ALL_STMT = "SELECT ADM_IDNUM,ADM_ACCOUNT,ADM_PASSWORD,ADM_NAME FROM ADM_MEB order by ADM_IDNUM";
	private static final String GET_ONE_STMT = "SELECT ADM_IDNUM,ADM_ACCOUNT,ADM_PASSWORD,ADM_NAME FROM ADM_MEB where ADM_IDNUM = ?";
	private static final String DELETE = "DELETE FROM ADM_MEB where ADM_IDNUM = ?";
	private static final String UPDATE = "UPDATE ADM_MEB set ADM_ACCOUNT=?, ADM_PASSWORD=?, ADM_NAME=? where ADM_IDNUM = ?";
	private static final String LOGIN = "SELECT ADM_IDNUM,ADM_ACCOUNT,ADM_PASSWORD,ADM_NAME FROM ADM_MEB where ADM_ACCOUNT = ? and ADM_PASSWORD = ?";
	@Override
	...
	public AdmMebVO login(String adm_account, String adm_password) {
		...
		try {
			...
			pstmt.setString(1, adm_account);
			pstmt.setString(2, adm_password);

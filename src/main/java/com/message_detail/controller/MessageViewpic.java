...
@WebServlet("/messageViewpic")
public class MessageViewpic extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res)
		...
		String mes_num = req.getParameter("mes_num");

		try {
			Statement stmt = con.createStatement();
			ResultSet rs = stmt.executeQuery(
					"SELECT MES_PIC FROM MESSAGE_DETAIL WHERE MES_NUM = " + mes_num );
			if (rs.next()) {

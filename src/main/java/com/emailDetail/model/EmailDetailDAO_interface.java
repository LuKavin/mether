...
public interface EmailDetailDAO_interface {
	...
	public String findAccount(Integer mem_Idnum);//用會員account找帳號的流水號
	public List<EmailDetailVO> findMailBox(String recipient,Integer mem_Idnum);//用收件者+MEM_IDnum整理出信箱

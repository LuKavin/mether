...
public interface EmailDetailDAO_interface {
	...
	public List<EmailDetailVO> findTrashCanBox(String mem_account);//用帳號找出信箱整理出信箱
...
//	public void update(EmailDetailVO emailDetailVO);
	...
	public void errorLetter(String memAccount,Integer memAccess, String wrongAccount);//用會員account找會員權限
